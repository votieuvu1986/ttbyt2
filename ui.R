...
tagList( #needed for shinyjs
  ...
  navbarPage(id = "intabset", #needed for landing page
           title = div(tags$a(img(src="logo-isofh.png", height=30), href= "https://isofh.com/"),
                       style = "position: relative; top: -5px;"), # Navigation bar
           windowTitle = "Quản lý trang thiết bị y tế", #title for browser tab
...
###############################################.
tabPanel(
  title = " Trang chủ", icon = icon("home"),
  mainPanel(width = 14, style="margin-left:4%; margin-right:4%",
            introBox(  
              fluidRow(column(8,(h3("Hệ thống hỗ trợ quản lý, khai thác và phân tích dữ liệu", style="margin-top:0px;"))),
                       (column(4,actionButton("btn_landing",label="Help: Take tour of the tool",icon=icon('question-circle'),class="down")))),
              data.step = 1,
              data.intro =(p(h4("Hệ thống hỗ trợ quản lý, khai thác và phân tích dữ liệu về công khai các trang thiết bị y tế Việt nam"),
            ...
            fluidRow(
              ...
              #Summary box
              column(4, class="landing-page-column",br(), #spacing
                     introBox(
                       lp_main_box(image_name= "landing_button_heatmap_2", 
                                   button_name = 'jump_to_summary', title_box = "Tổng quan",
              ...
              column(4, class="landing-page-column",
                     ...
                     introBox( # tour of the tool
                       lp_main_box(image_name= "landing_button_data_table", 
                                   button_name = 'jump_to_table', title_box = "Quản lý dữ liệu",
              ...
              #Trend plot box
              column(4, class="landing-page-column", br(),
                     lp_main_box(image_name= "landing_button_time_trend", 
                                 button_name = 'jump_to_trend', title_box = "Phân tích xu hướng",
            ...
            fluidRow(
              ...
              #          data.intro = h5("The trend and rank charts allow detailed exploration of one indicator at a time."),
                ...
                column(4, class="landing-page-column",
                       lp_main_box(image_name= "landing_button_maprank", 
                                   button_name = 'jump_to_rank', title_box = "Bản đồ xếp hạng",
              ...
              column(4, class="landing-page-column",
                     introBox(
                       ...
                       lp_main_box(image_name= "landing_button_health_inequality", 
                                   button_name = 'jump_to_ineq', title_box = "Phân tích tương quan",
              ...
              column(4, class="landing-page-column",
                     ...
                     lp_main_box(image_name= "landing_button_about_2", button_name = 'jump_to_about',
                                  title_box = "Giới thiệu", description = 'About ScotPHO Profiles')
...
## Summary ----
###############################################.
tabPanel("Tổng quan", icon = icon("list-ul"), value = "summary",
         introBox(
...
## Time trend ----
###############################################.
tabPanel("Xu hướng", icon = icon("area-chart"), value = "trend",
...
## Rank and map ---- 
###############################################.
tabPanel("Xếp hạng", icon = icon("signal"), value = "rank",
...
## Health inequalities ---- 
###############################################.
tabPanel("Tương quan", icon = icon("balance-scale"), value = "ineq",
...
## Data ----
###############################################.
tabPanel("Dữ liệu", icon = icon("table"), value = "table",
         #Sidepanel for filtering data
         mainPanel(
           width = 12, style="margin-left:0.5%; margin-right:0.5%",
           #Row 1 for intro  
           fluidRow(
             p("Hệ thống quản lý và khai thác dữ liệu", 
               style = "font-weight: bold; color: black;"),
             p("Sử dụng bộ lọc chi tiết theo các bảng và trường để lựa chọn dữ liệu mà bạn muốn tải xuống. ",
               "Lựa chọn khoảng thời gian bạn muốn truy xuất dữ liệu và chọn tải xuống hoặc xóa bộ lọc để bắt đầu lại phiên làm việc mới."),
             br()
           ),
           #Row 2 for selections
           fluidRow(
             column(3,
                    p("Lựa chọn bảng dữ liệu theo nhóm sản phẩm", style = "font-weight: bold; color: black;"),  
                    div("Thông tin của các sản phẩm lựa chọn sẽ hiện thị ở màn hình bên dưới."),br(),
                    awesomeRadio("product_filter", label=NULL, choices = c("Trang thiết bị y tế"="Indicator", "Vật tư y tế"="Domain", "IVD"="Profile"), selected = NULL, inline = FALSE,
             ...
             column(3,
                    p("Lựa chọn tiêu chí sản phẩm", style = "font-weight: bold; color: black;"),
                    # Scotland selections
             ...
             column(3, style = "width:20%",
                    p("Lựa chọn khoảng thời gian", style = "font-weight: bold; color: black;"),
                    ...
                    br(),
                    actionButton("clear", label = "Xóa bộ lọc",  icon ("eraser"), class = "down"),
                    downloadButton("download_table_csv", 'Tải về dữ liệu', class = "down")             
                    ) #column bracket
...
navbarMenu("Giới thiệu", icon = icon("info-circle"),
           ###############################################.
           ## About ----
           ###############################################.
...
###############################################.
#Copyright warning
tags$footer(column(6, "© Isofh Data Analysis Program v2.0 2021"), 
            column(2, tags$a(href="mailto:phs.scotpho@phs.scot", tags$b("Liên hệ"), 
                              class="externallink", style = "color: white; text-decoration: none")), 
            column(3, tags$a(href="https://www.scotpho.org.uk/about-us/scotpho-website-policies-and-statements/privacy-and-cookies", tags$b("Chính sách & Bản quyền"), 
                             class="externallink", style = "color: white; text-decoration: none")), 
